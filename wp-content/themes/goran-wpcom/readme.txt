...
= 29 August 2016 =
* Center last paragraph of the Grid/Featured Pages.
* Grid/Featured Pages, make sure excerpt in left-aligned and the read more button is centered.
* Add style for read more button wrapper.
